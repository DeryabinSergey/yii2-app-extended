...
class UserViewCest
{
	...
	public function checkUserAdmin(FunctionalTester $I): void
	{
		...
		$I->seeLink('Update', Url::to(['user/update', 'id' => 1]));
		$I->seeLink('Delete', Url::to(['user/delete', 'id' => 1]));
	}
	...
	public function checkUserManager(FunctionalTester $I): void
	{
		...
		$I->seeLink('Update', Url::to(['user/update', 'id' => 1]));
		$I->dontSeeLink('Delete', Url::to(['user/delete', 'id' => 1]));
	}
	...
	public function checkUserViewer(FunctionalTester $I): void
	{
		...
		$I->dontSeeLink('Update', Url::to(['user/update', 'id' => 1]));
		$I->dontSeeLink('Delete', Url::to(['user/delete', 'id' => 1]));
	}
}
